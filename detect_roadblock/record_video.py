...
name = time.time()
compressed_out = cv2.VideoWriter("/home/hll/bike_ws/videos/"+ str(name) + "_compressed_output.avi",fourcc, 25.0, (640,480))
raw_img_out = cv2.VideoWriter("/home/hll/bike_ws/videos/"+ str(name) + "_raw_output.avi",fourcc, 25.0, (640,480))
...
if __name__ == "__main__":
    ...
    sub_astra_raw_img = rospy.Subscriber(
        "/camera/color/image_raw", Image, sub_astra_raw_img_callback)
    rospy.spin()
