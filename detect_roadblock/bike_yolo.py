...
from utils.bike_utils import (cvtColor, get_classes, preprocess_input, resize_image,
                                   show_config)
from utils.bike_utils import decode_outputs, non_max_suppression
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        with torch.no_grad():
            ...
            if len(results[0]) == 0:
                ...
                max_conf_index = np.argmax(results[0][:, 4] * results[0][:, 5])
                top_label = np.array(results[0][max_conf_index, 6], dtype='int32')
                top_conf = results[0][max_conf_index, 4] * results[0][max_conf_index, 5]
                top_boxes = results[0][max_conf_index, :4]
...
if __name__ == "__main__":
    bike_yolo = YOLO('/home/wangzihanggg/codespace/bike/bike_vision_ws/src/bike_vision/detect_roadblock/pth/yolo.pth', '/home/wangzihanggg/codespace/bike/bike_vision_ws/src/bike_vision/detect_roadblock/pth/bike_obstacle_classes.txt')
