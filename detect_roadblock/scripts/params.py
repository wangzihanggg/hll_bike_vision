...
class BikeVisionParams(object):
    ...
    obstacle_points_3d = np.loadtxt("/home/wangzihanggg/codespace/bike/bike_vision_ws/src/bike_vision/detect_roadblock/params/obstacle_rect.txt")
    astra_camera_k = np.loadtxt("/home/wangzihanggg/codespace/bike/bike_vision_ws/src/bike_vision/detect_roadblock/params/camera_k.txt")
    astra_camera_d = np.loadtxt("/home/wangzihanggg/codespace/bike/bike_vision_ws/src/bike_vision/detect_roadblock/params/dist_matrix.txt")
